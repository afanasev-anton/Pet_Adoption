...
$queryList = mysqli_query($conn,"SELECT * FROM animals
        ...
        WHERE animals.type='sm' OR animals.type='lg'");
...
<body class="bg-light">
	<div class="container-fluid">
		...
		<div class="row p-3">
    		...
    		<?php 
            if (count($list)!=0) {                
                echo '<h3 class="w-100 text-center text-info">
                <i class="text-warning fas fa-star"></i> Our Stars <i class="text-warning fas fa-star"> </i>
                </h3>';
